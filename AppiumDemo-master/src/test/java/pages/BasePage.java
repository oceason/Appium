...
public class BasePage {
     ...
     * @param num
     */
    public void swipeToUp(AndroidDriver<WebElement> driver, int during, int num) {
     ...
     * @param num
     */
    public static void swipeToRight(AndroidDriver<WebElement> driver, int during, int num) {
        int width = driver.manage().window().getSize().width;
        int height = driver.manage().window().getSize().height;
        for (int i = 0; i < num; i++) {
